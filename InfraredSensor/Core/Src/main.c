...
void ReadInfrared(void)
{
    ...
    // Check the input pin values and perform an action only when the pin is at 0
	//middle pin

	//left most pin, does not work
    if ((GPIOB->IDR & GPIO_IDR_10) == 0) {
    	IRstate1 = 1;
    }
    else
    {
